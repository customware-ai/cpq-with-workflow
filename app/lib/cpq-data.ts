    ...
    estimates: [
      {
        ...
        build_selections: [
          ...
          {
            id: "sel-bundle-crane-package-2",
            item_id: "item-dc-pro-hoist",
            quantity: 1,
            source: "package",
            package_id: "pkg-crane-package",
          },
          {
            id: "sel-bundle-crane-package-3",
            item_id: "item-installation",
            quantity: 1,
            source: "package",
            package_id: "pkg-crane-package",
          },
          {
            id: "sel-service-inspection",
            item_id: "item-inspection-plan",
            quantity: 1,
            source: "catalog",
            package_id: null,
          },
        ...
        attachments: [
          ...
          {
            id: "att-drawing-001",
            file_name: "drawing-register.xlsx",
            kind: "Drawing Log",
            added_at: "2026-03-17T15:20:00.000Z",
          },
        ],
      ...
      },
      {
        ...
        region: "International",
        status: "draft",
        workflow_stage: "Proposal Build",
        notes: "Expansion quote for a second equipment lane.",
        intake_prompt: "",
        build_selections: [
          {
            id: "sel-wire-rope-hoist",
            item_id: "item-wire-rope-hoist",
            quantity: 1,
            source: "catalog",
            package_id: null,
          },
          {
            id: "sel-double-girder",
            item_id: "item-double-girder",
            quantity: 1,
            source: "catalog",
            package_id: null,
          },
        ...
        modifiers: ["freight"],
        attachments: [],
        updated_at: "2026-03-17T12:45:00.000Z",
      },
    ],
    catalog: [
      {
      ...
      {
        id: "item-double-girder",
        category: "Cranes",
        name: "Double Girder",
        sku: "CR-DG-63D",
        description: "High-capacity crane package for larger spans and lifts.",
        unit_price: 52_000,
        unit_cost: 35_600,
        lead_time_days: 63,
        uom: "EA",
      ...
      {
        id: "item-dc-com-hoist",
        category: "Hoists",
        name: "DC-Com Hoist",
        sku: "DC-COM-7D",
        description: "Standard-duty hoist for lighter daily cycles.",
        unit_price: 2_850,
        unit_cost: 1_995,
        lead_time_days: 7,
        uom: "EA",
      ...
      {
        id: "item-dc-pro-hoist",
        category: "Hoists",
        name: "DC-Pro Hoist",
        sku: "DC-PRO-10D",
        description: "Premium variable-speed hoist with service diagnostics.",
        unit_price: 4_600,
        unit_cost: 3_120,
        lead_time_days: 10,
        uom: "EA",
        tags: ["BUN", "Variable speed"],
      },
      {
        id: "item-wire-rope-hoist",
        category: "Hoists",
        name: "Wire Rope Hoist",
        sku: "WRH-28D",
        description: "Heavy-duty hoist for demanding production lifts.",
        unit_price: 12_800,
        unit_cost: 8_960,
        lead_time_days: 28,
        uom: "EA",
      ...
      {
        id: "item-system-upgrade",
        category: "Services",
        name: "System Upgrade",
        sku: "SVC-RET-14D",
        description: "Retrofit package for controls and modernized hardware.",
        unit_price: 3_200,
        unit_cost: 2_100,
        lead_time_days: 14,
        uom: "EA",
      ...
      },
      {
        ...
        name: "Installation",
        sku: "SVC-INST-10D",
        description: "On-site commissioning and installation support.",
        unit_price: 4_500,
        unit_cost: 2_950,
        lead_time_days: 10,
        uom: "EA",
    ...
    packages: [
      {
        ...
        name: "Crane Package",
        description: "Under Running SG + DC-Pro Hoist + Installation",
        discount_rate: 0.05,
        items: [
          { item_id: "item-under-running-sg", quantity: 1 },
          { item_id: "item-dc-pro-hoist", quantity: 1 },
          { item_id: "item-installation", quantity: 1 },
        ],
      },
      {
        id: "pkg-inspect-audit",
        name: "Inspect+Audit",
        description: "Inspection Plan + System Upgrade",
        discount_rate: 0.08,
        items: [
          { item_id: "item-inspection-plan", quantity: 1 },
          { item_id: "item-system-upgrade", quantity: 1 },
        ],
      },
    ],
    ui: {
